# Contributing to MactermKit

Thank you for your interest in contributing to **MactermKit**! MactermKit is a native terminal emulator framework and VT100/ANSI engine for macOS.
...
1. Fork the repository and clone your fork locally:
   ```bash
   git clone https://github.com/<your-username>/MactermKit.git
   cd MactermKit
   ```
2. Build the package:
   ```bash
...
By contributing to MactermKit, you agree that your contributions will be licensed under the [MIT License](LICENSE).
